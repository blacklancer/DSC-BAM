...
def SCkd(a, b, device=None, normalize=False):
    # a = torch.pow(a, 2)
    # b = torch.pow(b, 2)
...
def incremental_phase_4(args, tg_model, ref_model, tg_optimizer, tg_lr_scheduler, \
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (inputs, targets) in enumerate(trainloader):
            ...
            if is_start_iteration:
                ...
                loss3 = (loss311*1 + loss312*0 + loss321*1 + loss322*0 + loss331*1 + loss332*0) * lamda
        ...
        print('Train set: {}, '
              ...
              'Train Loss2: {:.4f},'
              'Train Loss3: {:.4f},\n'
              'Train Loss311: {:.4f},Train Loss321: {:.4f},Train Loss331: {:.4f},'
              'Train Loss312: {:.4f},Train Loss322: {:.4f},Train Loss332: {:.4f},'
